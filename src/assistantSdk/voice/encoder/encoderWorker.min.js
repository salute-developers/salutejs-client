...
var resolveWasmBinaryFileUrl;
var wasmBinaryFileUrlPromise = new Promise((resolve) => {
    resolveWasmBinaryFileUrl = (url) => resolve(url);
});
            ...
            (function (t) {
                ...
                t.onmessage = function (e) {
                    if (e.data.command === 'init') {
                        resolveWasmBinaryFileUrl(e.data.wasmUrl || './encoderWorker.min999.wasm');
                    }
                    ...
                    r.then(function () {
                        switch (e.data.command) {
                            case 'encode':
                                ...
                                break;
                            case 'getHeaderPages':
                                n && (n.generateIdPage(), n.generateCommentPage());
                                break;
                            case 'done':
                                n && (n.encodeFinalFrame(), t.postMessage({ message: 'done' }));
                                break;
                            case 'close':
                                t.close();
                                break;
                            ...
                            case 'setPort':
                                if (e.data.port) {
                                    ...
                                    port.onmessage = function (event) {
                                        if (event.data) {
                                            n && n.encode([new Float32Array(event.data)]);
                                        }
                                    };
                                    t.postMessage({ message: 'port_ready' });
                                }
                                break;
                            case 'setOutPort':
                                if (e.data.port) {
                                    n && n.setOutPort(e.data.port);
                                }
                                break;
                            case 'init':
                                n && n.destroy(), (n = new i(e.data, Module)), t.postMessage({ message: 'ready' });
                        }
                    });
                };
                var i = function (e, t) {
                    ...
                    (this.config = Object.assign(
                        ...
                        this.initCodec(),
                        this.initResampler(),
                        1 === this.config.numberOfChannels
                ...
                (i.prototype.encode = function (e) {
                    for (var t = this.interleave(e), n = 0; n < t.length; ) {
                        ...
                        if (
                            (this.resampleBuffer.set(t.subarray(n, n + s), this.resampleBufferIndex),
                            (n += s),
                            (this.resampleBufferIndex += s),
                            this.resampleBufferIndex === this.resampleBufferLength)
                        ) {
                            this._speex_resampler_process_interleaved_float(
                                this.resampler,
                            ...
                            this.segmentPacket(r),
                                (this.resampleBufferIndex = 0),
                                this.framesInPage++,
                                this.framesInPage >= this.config.maxFramesPerPage && this.generatePage();
                        }
                    }
                }),
                    ...
                    (i.prototype.flush = function () {
                        this.framesInPage && this.generatePage(),
                            (this.resampleBufferIndex = 0),
                            t.postMessage({ message: 'flushed' });
                    }),
                    (i.prototype.encodeFinalFrame = function () {
                        if (this.resampleBufferIndex > 0) {
                            for (var e = [], t = 0; t < this.config.numberOfChannels; ++t)
                                e.push(
                                    new Float32Array(
                                        this.config.bufferLength -
                                            this.resampleBufferIndex / this.config.numberOfChannels,
                                    ),
                                );
                            this.encode(e);
                        }
                        (this.headerType += 4), this.generatePage();
                    }),
                    (i.prototype.getChecksum = function (e) {
                        for (var t = 0, n = 0; n < e.length; n++)
                            t = (t << 8) ^ this.checksumTable[((t >>> 24) & 255) ^ e[n]];
                        return t >>> 0;
                    }),
                    (i.prototype.generateCommentPage = function () {
                    ...
                    (i.prototype.generateIdPage = function () {
                        var e = new DataView(this.segmentData.buffer);
                        e.setUint32(0, 1937076303, !0),
                            e.setUint32(4, 1684104520, !0),
                            e.setUint8(8, 1, !0),
                            e.setUint8(9, this.config.numberOfChannels, !0),
                    ...
                    (i.prototype.generatePage = function () {
                        var e = this.lastPositiveGranulePosition === this.granulePosition ? -1 : this.granulePosition,
                            ...
                            s = new DataView(n),
                            r = new Uint8Array(n);
                        s.setUint32(0, 1399285583, !0),
                            s.setUint8(4, 0, !0),
                            s.setUint8(5, this.headerType, !0),
                            s.setUint32(6, e, !0),
                            e < 0
                                ? s.setInt32(10, Math.ceil(e / 4294967297) - 1, !0)
                                : s.setInt32(10, Math.floor(e / 4294967296), !0),
                            s.setUint32(14, this.config.serial, !0),
                            s.setUint32(18, this.pageIndex++, !0),
                            s.setUint8(26, this.segmentTableIndex, !0),
                            r.set(this.segmentTable.subarray(0, this.segmentTableIndex), 27),
                            r.set(this.segmentData.subarray(0, this.segmentDataIndex), 27 + this.segmentTableIndex),
                            s.setUint32(22, this.getChecksum(r), !0);
                        if (this.outPort) {
                            this.outPort.postMessage(r.buffer, [r.buffer]);
                        } else {
                            t.postMessage({ message: 'page', page: r, samplePosition: this.granulePosition }, [
                                r.buffer,
                            ]);
                        }
                        (this.segmentTableIndex = 0),
                    ...
                    (i.prototype.initChecksumTable = function () {
                        this.checksumTable = [];
                        for (var e = 0; e < 256; e++) {
                    ...
                    (i.prototype.initCodec = function () {
                        ...
                        (this.encoder = this._opus_encoder_create(
                            ...
                            this._free(e),
                            this.config.encoderBitRate && this.setOpusControl(4002, this.config.encoderBitRate),
                            this.config.encoderComplexity && this.setOpusControl(4010, this.config.encoderComplexity),
                            (this.encoderSamplesPerChannel =
                                (this.config.encoderSampleRate * this.config.encoderFrameSize) / 1e3),
                            ...
                            (this.encoderBufferPointer = this._malloc(4 * this.encoderBufferLength)),
                    ...
                    (i.prototype.initResampler = function () {
                        var e = this._malloc(4);
                        (this.resampler = this._speex_resampler_init(
                            ...
                            (this.resampleSamplesPerChannel =
                                (this.config.originalSampleRate * this.config.encoderFrameSize) / 1e3),
                            ...
                            (this.resampleBufferPointer = this._malloc(4 * this.resampleBufferLength)),
                    ...
                    (i.prototype.interleave = function (e) {
                    ...
                    (i.prototype.segmentPacket = function (e) {
                        for (var t = 0; e >= 0; ) {
                            255 === this.segmentTableIndex && (this.generatePage(), (this.headerType = 1));
                            var n = Math.min(e, 255);
                            (this.segmentTable[this.segmentTableIndex++] = n),
                                this.segmentData.set(
                                    this.encoderOutputBuffer.subarray(t, t + n),
                                    this.segmentDataIndex,
                                ),
                                (this.segmentDataIndex += n),
                                (t += n),
                                (e -= 255);
                        }
                        (this.granulePosition += 48 * this.config.encoderFrameSize),
                            255 === this.segmentTableIndex && (this.generatePage(), (this.headerType = 0));
                    }),
                    (i.prototype.setOutPort = function (port) {
                        this.outPort = port;
                    }),
                    Module || (Module = {}),
                    (Module.mainReady = r),
                    (Module.OggOpusEncoder = i),
...
var wasmMemory;
var wasmTable = new WebAssembly.Table({ initial: 16, maximum: 16, element: 'anyfunc' });
var ABORT = false;
var EXITSTATUS = 0;
...
function getBinaryPromise() {
    if (!wasmBinary && (ENVIRONMENT_IS_WEB || ENVIRONMENT_IS_WORKER) && typeof fetch === 'function') {
        return wasmBinaryFileUrlPromise.then((url) => {
            return fetch(url)
...
function createWasm() {
    ...
    function instantiateAsync() {
        if (
            ...
            wasmBinaryFileUrlPromise.then((url) => {
